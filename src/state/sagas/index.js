...
/** Минусы:
    ...
    - Сложность кода в сравнении с thunk и async/awaiy
    - Время на чтение чужого кода в случае не знания API
    - Время на изучения ее работы новичку
    - Скорость написания (из-за появления нового магического слоя - приходится танцевать с бубном)
    - Generator - старая дичь, которую я так не припомню гдк используют кроме как в Саге
 */
